-- HTML is accepted only for manager office attachments; no inline rendering.
begin;
...
update storage.buckets set allowed_mime_types=array['application/pdf','text/html','image/jpeg','image/png','image/tiff'] where id='auditoria-private' and public=false;
commit;
