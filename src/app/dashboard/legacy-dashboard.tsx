    ...
    async function carregarDashboard() {
      try {
        ...
        const { data: rbkAdmin } = await supabase
          ...
          .eq("ativo", true)
          .maybeSingle();
        setIsSuperadmin(Boolean(rbkAdmin));
    ...
    <main className="rbk-shell min-h-screen">
      ...
      <div className="rbk-container py-8 sm:py-10">
        ...
        {carregando ? (
          ...
          <>
            <ProcessosCard />
            <section className="mb-6 rbk-card p-5"><Link href="/processos/credenciamento" className="font-bold text-red-700">Processos → Credenciamento PFPB</Link><p className="mt-2 text-sm text-gray-500">Ficha, documentos e pré-análise interna do Gestor RBK.</p></section>
            ...
            <section className="mt-10">
              <Link href="/monitoramento" className="rbk-card rbk-card-hover block p-6">
                <h2 className="text-xl font-bold text-gray-900">Centro de Monitoramento</h2>
                <p className="mt-2 text-sm text-gray-600">Acompanhe as farmácias da sua carteira.</p>
                <span className="mt-4 inline-block text-sm font-bold text-red-600">Abrir monitoramento →</span>
              </Link>
            </section>

            {isSuperadmin && <section className="mt-10">
              <div className="mb-5">
                <p className="text-sm font-bold uppercase tracking-[0.16em] text-red-600">
                  Administração
                </p>
