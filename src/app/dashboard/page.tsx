  ...
  return (
    <main className="rbk-shell min-h-screen">
      ...
      <div className="rbk-container py-8 sm:py-10">
        <div className="mb-8">
          <p className="text-xs font-bold uppercase tracking-[0.16em] text-red-600">Visão geral</p>
        ...
        <section className="mt-8">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <Link href="/nova-autorizacao" className="rbk-card rbk-card-hover group p-6">
              <div className="mb-5 flex h-11 w-11 items-center justify-center rounded-xl bg-red-50 text-lg font-bold text-red-600">+</div>
            ...
            <Link href="/autorizacoes" className="rbk-card rbk-card-hover group p-6">
                    <h3 className="text-base font-bold text-gray-900">Autorizações</h3>
            ...
            <Link href="/autorizacoes" className="rbk-card rbk-card-hover group p-6">
              <div className="mb-5 flex h-11 w-11 items-center justify-center rounded-xl bg-amber-50 text-sm font-bold text-amber-600">DOC</div>
              <h3 className="text-base font-bold text-gray-900">Documentos</h3>
              <p className="mt-2 text-sm leading-5 text-gray-500">Acompanhe os documentos vinculados às autorizações.</p>
              <span className="mt-5 inline-block text-sm font-bold text-red-600 group-hover:text-red-700">Gerenciar →</span>
            </Link>
          </div>
        </section>
      </div>
